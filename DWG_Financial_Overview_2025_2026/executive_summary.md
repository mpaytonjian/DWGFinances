# DWG — Preliminary Management Financial Overview
### Preliminary Management Financial Overview Based Primarily on Available Cash Activity
...
- Cash/charge-basis only; not GAAP, tax-basis, reviewed, or audited.
- Bank statements, card ending balances, payroll registers, loan schedules, A/R, A/P, and equity are **not yet loaded**.
- Only the card side of credit-card payments and transfers is visible.
- Entity allocation for any 'Unassigned' rows is preliminary.

## Immediate Accounting Cleanup Priorities

1. Load remaining source workbooks (Group, Partners full-year, Poseidon, Plum, Family, Angela, Venmo).
2. Provide bank & card statements to confirm balances and the paying side of transfers.
3. Confirm personal-vs-business dispositions to clear Due To/From Owner.
4. Supply payroll registers and loan amortization schedules.
5. Approve or revise the proposed adjusting entries.

---
*Automated controls: 10/10 passed. See the Source Control sheet for detail.*